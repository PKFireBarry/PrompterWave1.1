...
export default function Home() {
  ...
  <div className="flex flex-col rounded-xl outline bg-[#ececf2] items-center justify-center space-y-4">
    <div className="space-y-2 p-4">
      <motion.h1 className="text-3xl font-bold  tracking-tighter sm:text-5xl xl:text-6xl/none dark:text-gray-400" initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        Introducing
      </motion.h1>
      <motion.h1 className="text-3xl font-bold underline tracking-tighter sm:text-5xl xl:text-6xl/none" initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.5, delay: 0.75 }}>
        PrompterWave
      </motion.h1>
      <div className="max-w-[600px] p-4 md:text-xl dark:text-gray-400">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }} className="flex items-start mb-8">
          <MergeIcon className="w-8 h-8 mr-4 mt-1 text-[#251982]" />
          <span className="text-sm font-semibold text-[#251982] mr-4">Effortless Prompting:</span> 
          <p className="text-sm font-bold">Experience seamless integration and efficient results, allowing you to focus solely on unleashing your creativity.</p>
        </motion.div>
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.6 }} className="flex items-start mb-8">
          <SparklesIcon className="w-8 h-8 mr-4 mt-1 text-[#251982]" />
          <span className="text-sm font-semibold text-[#251982] mr-4">Advanced LLM Technology:</span> 
          <p className="text-sm font-bold">Unlock the power of cutting-edge GPT-4 to effortlessly prompt stunning images. Our user-friendly interface ensures ease of use for all skill levels.</p>
        </motion.div>
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 1 }} className="flex flex-col gap-2 min-[400px]:flex-row p-4">
      {user ? (
        <Button className="inline-flex text-black hover:underline h-10 items-center justify-center rounded-md border border-gray-200 bg-white px-8 text-sm font-medium shadow-sm transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-800 dark:bg-gray-950 dark:hover:bg-gray-800 dark:hover:text-gray-50 dark:focus-visible:ring-gray-300" onClick={handleSignOut}>Logout</Button>
      ) : (
        <Button className="inline-flex text-black hover:underline h-10 items-center justify-center rounded-md border border-gray-200 bg-white px-8 text-sm font-medium shadow-sm transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-800 dark:bg-gray-950 dark:hover:bg-gray-800 dark:hover:text-gray-50 dark:focus-visible:ring-gray-300" onClick={handleLogin}>Login</Button>
      )}
      <Link
        ...
        Pricing
            ...
            <div>
              <motion.div
                ...
                animate={{ opacity: 1 }}
                className="overflow-y-hidden overflow-x-hidden outline p-12 rounded-xl h-[650px] items-center bg-[#090810]"
              >
                {" "}
                {history && Array.isArray(history) && history.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center justify-start overflow-y-hidden">
