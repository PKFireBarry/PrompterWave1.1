  ...
  const addUserToDatabase = async (userData: {
    ...
    try {
      ...
      if (userDocSnapshot.exists()) {
        ...
        // Update the document status to 'active' if the user is not subscribed
        if (userDocSnapshot.data()?.status == "false") {
      ...
      await setDoc(userDocRef, { ...userData, status: "active" });
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="max-w-[600px] mx-auto text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                    Your data is secure with us. Click continue to access the
                    platform.
                    <br />
                    <div className="font-bold">
                      {isLoading
                        ? "Adding a new user..."
                        : "OK! youre all set welcome to Pro Mode!"}
                    </div>
                  </div>
                  <button
